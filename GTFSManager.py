...
uploadFolder = os.path.join(root,'data/uploads/')
xmlFolder = os.path.join(root,'xml_related/')
logFolder = os.path.join(root,'data/logs/')
configFolder = os.path.join(root,'config/')
dbFolder = os.path.join(root,'data/db/') # 12.5.18 new pandas DB storage
exportFolder = os.path.join(root,'data/export/') # 4.9.18 putting exports here now

sequenceDBfile = os.path.join(root,'data/db/sequence.json')
